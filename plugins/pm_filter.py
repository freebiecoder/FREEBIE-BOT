...
async def next_page(bot, query):
    ...
    if n_offset == 0:
        ...
        btn.insert(0,
            [
                InlineKeyboardButton("Updates", url="https://t.me/legends_Bots"),
            ]
        )
        btn.insert(1,
            [
...
async def auto_filter(client, msg, spoll=False):
    ...
    btn.insert(0,
        [
            InlineKeyboardButton("Update Channel", url="https://t.me/legends_Bots"),
        ]
    )
...
async def advantage_spell_chok(msg):
    ...
    gs_parsed = []
    if not g_s:
        k = await msg.reply("<b>I couldn't find anything in that name.</b>")
